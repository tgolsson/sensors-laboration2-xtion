...
title("Variance"); 
plot(X, stddev50cm20x20(60:mLength), "r-",'linewidth', 2);
plot(X, stddev50cm40x40(60:mLength),"g-",'linewidth', 2);
plot(X, stddev50cm60x60(60:mLength), "b-", 'linewidth', 2);
plot(X, stddev50cm80x80(60:mLength), "k-", 'linewidth', 2);
plot(X, stddev50cm100x100(60:mLength), "c-", 'linewidth', 2);
legend("20x20", "40x40", "60x60", "80x80", "100x100", "location", "southoutside","orientation", "horizontal");
legend("boxoff")
xlabel("Sample");
ylabel("Variance");
...
stddevs = [mean(stddev50cm20x20(60:mLength)) mean(stddev50cm40x40(60:mLength)) mean(stddev50cm60x60(60:mLength)) mean(stddev50cm80x80(60:mLength)) mean(stddev50cm100x100(60:mLength))];
