...
title("Variance"); 
plot(X, variance50cm20x20(1:mLength), "r-",'linewidth', 2);
plot(X, variance50cm40x40(1:mLength),"g-",'linewidth', 2);
plot(X, variance50cm60x60(1:mLength), "b-", 'linewidth', 2);
plot(X, variance50cm80x80(1:mLength), "k-", 'linewidth', 2);
plot(X, variance50cm100x100(1:mLength), "c-", 'linewidth', 2);
legend("20x20", "40x40", "60x60", "80x80", "100x100", "location", "southoutside","orientation", "horizontal");
legend("boxoff")
xlabel("Sample");
ylabel("Variance");
...
variances = [mean(variance50cm20x20) mean(variance50cm40x40) mean(variance50cm60x60) mean(variance50cm80x80) mean(variance50cm100x100)];
